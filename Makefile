...
EXEC_FILES=rational-test utilities-test
...
rational-test: utilities/utilities.hpp rational/rational.hpp rational/rational-test.cpp
	$(CXX) $(CXXFLAGS) rational/rational.cpp utilities/utilities.cpp rational/rational-test.cpp -o rational-test
